...
data_augmentation = pd.read_csv('data/augmentation.csv')
...
X_train = np.load('/data/embedding/X_train.npy')
X_val = np.load('/data/embedding/X_val.npy')
X_test = np.load('/data/embedding/X_test.npy')
...
p, r = evaluate(pred, y_test)
np.save('predictions/tempo.npy', pred)